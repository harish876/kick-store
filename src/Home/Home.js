...
export function Shapes() {
  ...
  return (
    <>
      ...
      <ConverseDoodle position={[-width / 2.5, height / 8, -1]} scale={[0.8, 0.8, 0.8]}/>
...
export function Categories({ time = 3000 }) {
  ...
  const cats = useMemo(
    () => [
      { npm: 'about', description: ' to know more about us.' },
      { npm: 'contact us', description: 'let us know what we can do for you' }
    ],
    []
  )
